...
public class DeptVo extends BaseVo {
    ...
    @Builder
    public DeptVo(Long id, String dataState, String parentDeptNo, String deptNo, String deptName, Integer sortNo, Long leaderId, String leaderName, String[] checkedIds, String[] checkedDeptNos, String roleId, Integer level) {
        super(id, dataState);
