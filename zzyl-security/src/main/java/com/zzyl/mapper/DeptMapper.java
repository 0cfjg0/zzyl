...
public interface DeptMapper {
    ...
    List<Dept> selectList(@Param("deptVo") DeptDto deptDto);
     ...
     * @return 结果
     */
    public int deleteDeptById(@Param("deptId") String deptId);

    @Select("select dept_no from  sys_dept where dept_name = #{deptName}")
    String selectByDeptName(@Param("deptName") String deptName);
